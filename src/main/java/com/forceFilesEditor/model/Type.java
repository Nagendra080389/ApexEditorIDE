...
public class Type extends AbstractCompletionProposalDisplayable {
    ...
    public PatriciaTrie<ArrayList<AbstractCompletionProposalDisplayable>> getConstructorTrie() {
        return constructorTrie;
    }

    public PatriciaTrie<ArrayList<AbstractCompletionProposalDisplayable>> getMethodTrie() {
        return methodTrie;
    }

    public PatriciaTrie<AbstractCompletionProposalDisplayable> getPropertyTrie() {
        return propertyTrie;
    }
}